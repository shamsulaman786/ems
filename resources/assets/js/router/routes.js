export default ({ authGuard, guestGuard }) => [
  ...
  ...authGuard([
    ...
    { path: '/question_bank', name: 'question_bank', component: require('~/pages/question/bank.vue') },
    { path: '/question_paper', name: 'question_paper', component: require('~/pages/question/paper.vue') },
    { path: '/settings',
